...
@endif
  ...
  @if (isset($data['editSolicitud']) && (Permisos::control('1|204|205')) && ($data['solicitud_pj_creada']!=1))
@if($data['editTipo'] == 'vista')
...
@if ($data['solicitud_pj_creada']==1 )
<div class="bg-success p-2">ENTIDAD CREADA</div>
@endif
   ...
   @if (isset($data['edit']))
    ...
    <!-- eliminar -->
    @if (isset($data['delete']) && (Permisos::control('1|205')) && ($data['solicitud_pj_creada']!=1))

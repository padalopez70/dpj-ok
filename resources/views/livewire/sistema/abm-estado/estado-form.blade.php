        ...
        <div class="container">
            <x-form-section submit="guardar" autocomplete="off">
                ...
                <x-slot name="form">
                    ...
                    <div class="col-span-6">
                        <x-jet-label for="titulo" value="Denominación del Estado *" />
                        <x-jet-input wire:model.defer='estado.denominacion_estado' type="text" name="estado" id="estado"
                            class="w-full block" />
                        <x-jet-input-error for="estado.denominacion_estado" />
                    </div>

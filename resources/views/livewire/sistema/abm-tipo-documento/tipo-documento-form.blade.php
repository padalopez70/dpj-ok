<div>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Crear o Editar un Tipo de Documento</h2>
    </x-slot>
        ...
        <div class="container">
            <x-form-section submit="guardar" autocomplete="off">
                ...
                <x-slot name="form">
                    ...
                    <div class="col-span-6">
                        <x-jet-label for="titulo" value="Nombre del Tipo de Documento *" />
                        <x-jet-input wire:model.defer='tipoDocumento.denominacion_tipo_documento' type="text" name="tipoDocumento" id="tipDocumento"
                            class="w-full block" />
                        <x-jet-input-error for="tipoDocumento.denominacion_tipo_documento" />
                    </div>

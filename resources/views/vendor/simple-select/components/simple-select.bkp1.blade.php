<!-- corregido color para que sea similar a jetstream y nada mas -->
<div
@php
    ...
    <div x-ref="simpleSelectOptionsContainer" x-bind:style="open ? 'height: ' + popperHeight : ''" class="absolute z-10 w-full">
        <div x-show="open">
            ...
            <ul
                ...
                class="!text-base absolute z-10 w-full py-1 overflow-auto bg-white shadow-lg rounded-b-md max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
                tabindex="-1"
                role="listbox"
            >

...
namespace App\Http\Livewire\Sistema\AbmSolicitud;
...
class SolicitudForm extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.sistema.abm-solicitud.solicitud-form');
    }
    ...
    public function mount(Novedad $novedad)
    {
        ...
        //$this->novedad->solicitud_pj_aprobada = null; // o cualquier otro valor por defecto que necesites
        ...
        if(!$this->novedad->id){
            //dd($this->novedad->id);
            $this->label_formulario ="Crear Solicitud de Personería";
        ...
        else $this->label_formulario ="Editar Expediente";
        ...
        $this->view = 'sis.solicitudes.index';
    }
    ...
    public function limpiarForm()
    {
        ...
        $this->novedad->id_tipo_novedad = 12;
        $this->novedad->solicitud_pj_aprobada = "";
 ...
 */
    ...
    {
        return [
            'novedad.solicitud_nombre_entidad' => 'required',
            ...
            'novedad.solicitud_pj_aprobada' => 'required',

...
class SolicitudSaForm extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.sistema.abm-solicitud-sa.solicitudsa-form');
    }
    ...
    public function mount(Novedad $novedad)
    {
        ...
        if(!$this->novedad->id){
            //dd($this->novedad->id);
            $this->label_formulario ="Crear Sociedad Anonima";
        ...
        else $this->label_formulario ="Editar Sociedad Anonima";
        ...
        $this->view = 'sis.solicitudes.sa.index';
    }
    ...
    public function limpiarForm()
    {
        ...
        $this->novedad->id_tipo_novedad = 13;
